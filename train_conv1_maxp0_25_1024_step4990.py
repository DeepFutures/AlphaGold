...
W_fc1 = weight_variable([15 * 15 * 25, 1024])
#variable_summaries(W_fc1)
b_fc1 = bias_variable([1024])
#variable_summaries(b_fc1)

h_conv1_flat = tf.reshape(h_conv1, [-1, 15*15*25])
...
'''
saver.restore(sess, "/home/lxiao/Documents/save/AlphaGold0/alpha_gold0.ckpt")
...
for i in range(5000):
  if i%100 == 0:
    ...
    save_path = saver.save(sess, "/home/lxiao/Documents/save/AlphaGold0/alpha_gold0.ckpt")
