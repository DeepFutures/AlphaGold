...
W_conv4 = weight_variable([5, 5, 36, 72])
#variable_summaries(W_conv2)
...
W_fc1 = weight_variable([1 * 1 * 72, 1024])
#variable_summaries(W_fc1)
b_fc1 = bias_variable([1024])
#variable_summaries(b_fc1)

h_pool4_flat = tf.reshape(h_pool4, [-1, 1*1*72])
...
'''
saver.restore(sess, "/home/lxiao/Documents/save/AlphaGold4/alpha_gold4.ckpt")
...
for i in range(10000):
  if i%100 == 0:
    ...
    save_path = saver.save(sess, "/home/lxiao/Documents/save/AlphaGold4/alpha_gold4.ckpt")
...
print("test accuracy %g"%accuracy.eval(feed_dict={
    x: images_test.images, y_: labels_test.labels, keep_prob: 1.0}))
