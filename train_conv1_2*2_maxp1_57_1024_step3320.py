...
W_conv1 = weight_variable([2, 2, 1, 57])
#variable_summaries(W_conv1, name = 'W_conv1')
b_conv1 = bias_variable([57])
...
'''
W_conv2 = weight_variable([4, 4, 4, 16])
...
W_fc1 = weight_variable([8 * 8 * 57, 1024])
#variable_summaries(W_fc1)
b_fc1 = bias_variable([1024])
#variable_summaries(b_fc1)

h_pool1_flat = tf.reshape(h_pool1, [-1, 8*8*57])
