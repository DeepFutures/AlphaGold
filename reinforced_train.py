...
W_conv1 = weight_variable([8, 8, 1, 120])
...
W_conv2 = weight_variable([4, 4, 120, 60])
...
W_conv3 = weight_variable([2, 2, 60, 30])
#variable_summaries(W_conv2)
...
W_conv4 = weight_variable([1, 1, 30, 15])
#variable_summaries(W_conv2)
b_conv4 = bias_variable([15])
#variable_summaries(b_conv2)
...
W_fc1 = weight_variable([1 * 1 * 15, 1024])
#variable_summaries(W_fc1)
b_fc1 = bias_variable([1024])
#variable_summaries(b_fc1)

h_pool1_flat = tf.reshape(h_pool4, [-1, 1*1*15])
...
train_step = tf.train.ProximalAdagradOptimizer(1e-4).minimize(cross_entropy)
...
save_path = saver.save(sess, "/home/lxiao/Documents/save/AlphaGold/alpha_gold.ckpt")
save_path = saver.save(sess, "/home/lxiao/Documents/save/AlphaGold2/alpha_gold.ckpt")
'''
saver.restore(sess, "/home/lxiao/Documents/save/AlphaGold/alpha_gold.ckpt")
print("Model restored")
'''
accmax = sess.run(accuracy, feed_dict={x: images_test.images, y_: labels_test.labels, keep_prob: 1.0})
train_accmax = accuracy.eval(feed_dict={
...
for i in range(1000000):
  ...
  if (acc == accmax) & (train_accuracy < train_accmax):
    saver.restore(sess, "/home/lxiao/Documents/save/AlphaGold2/alpha_gold.ckpt")
    print("Model restored")
