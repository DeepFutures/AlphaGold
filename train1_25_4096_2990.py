...
W_fc1 = weight_variable([8 * 8 * 25, 4096])
#variable_summaries(W_fc1)
b_fc1 = bias_variable([4096])
#variable_summaries(b_fc1)

h_pool1_flat = tf.reshape(h_pool1, [-1, 8*8*25])
h_fc1 = tf.nn.relu(tf.matmul(h_pool1_flat, W_fc1) + b_fc1)
#tf.summary.histogram('h_fc1', h_fc1)
keep_prob = tf.placeholder(tf.float32)
h_fc1_drop = tf.nn.dropout(h_fc1, keep_prob)

W_fc2 = weight_variable([4096, 15])
...
'''
saver.restore(sess, "/home/lxiao/Documents/save/AlphaGold1/alpha_gold1.ckpt")
...
for i in range(3000):
  if i%100 == 0:
    ...
    save_path = saver.save(sess, "/home/lxiao/Documents/save/AlphaGold1/alpha_gold1.ckpt")
